            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                if (self.epoch % cfg.training.sample_every) == 0:
                    with torch.no_grad():
                        ...
                        gt_action = gt_action[:, 7:15, :]
                        result = policy.predict_action(obs_dict)
                        pred_action = result["action_pred"][:, 16:24, :]
                ...
                if ((self.epoch + 1) % cfg.training.checkpoint_every) == 0:
                    ...
                    self.save_checkpoint(f"/DATA/disk1/RoboTwin2_checkpoints/DP_ourpolicypro/{save_name}-{seed}/{self.epoch + 1}.ckpt")  # TODO
