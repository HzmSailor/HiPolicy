...
class Base_task(gym.Env):
    ...
    def apply_dp(self, model, args):
        ...
        if eval_video_log:
            ...
            base_save_dir = Path('/DATA/disk1/eval_video') / save_dir
            base_save_dir.mkdir(parents=True, exist_ok=True)
            
            # Create separate directories for different data types
            video_dir = base_save_dir / 'head_camera_video_900_126_fulllowdim'
    ...
    def apply_dp3(self, model, args):
        ...
        if eval_video_log:
            ...
            from pathlib import Path
            from envs.utils.save_file import save_img
            save_dir = Path('/DATA/disk1/eval_video') / save_dir
            save_dir.mkdir(parents=True, exist_ok=True)
            
            # Create separate directories for different data types
            video_dir = save_dir / 'head_camera_video_900_126_fulllowdim'
